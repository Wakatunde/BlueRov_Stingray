...
source $HOME/Stingray2_ws/install/setup.bash
...
export GZ_SIM_RESOURCE_PATH=$HOME/Stingray2_ws/src/stingray_simulation/models:$HOME/Stingray2_ws/src/stingray_simulation/worlds:$GZ_SIM_RESOURCE_PATH
