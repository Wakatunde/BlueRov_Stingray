...
static const _StingrayControl_type_support_symbol_names_t _StingrayControl_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, stingray_msg, msg, StingrayControl)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, stingray_msg, msg, StingrayControl)),
  }
};
...
{
  return &::stingray_msg::msg::rosidl_typesupport_cpp::StingrayControl_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, stingray_msg, msg, StingrayControl)() {
  return get_message_type_support_handle<stingray_msg::msg::StingrayControl>();
}
